...
import joblib
import pandas as pd
from notebooks.legacy.utils.pipeline import pipeline_LDA, pipeline_RC
...
# Save model to pkl
joblib.dump(pipe_LDA, 'C:/Users/yinmi/Becode_projects/football-prediction-fc-charneux/notebooks/models/model_LDA_withOdds.pkl')
joblib.dump(pipe_RC, 'C:/Users/yinmi/Becode_projects/football-prediction-fc-charneux/notebooks/models/model_RC_withoutOdds.pkl')